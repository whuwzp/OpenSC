...
implements IFloodlightModule, ILearningSwitchService, IOFMessageListener {
	 ...
	 * @param mac The MAC address of the host to addSwitch
	...
	protected void addToPortMap(IOFSwitch sw, MacAddress mac, VlanVid vlan, OFPort portVal) {
		...
		log.info("___________________________________________", swMap);
		System.out.print(swMap+""+'\n');
		System.out.println(mac +":" +portVal);
